...
<head>
  ...
  <title>Peticiones Asesorias</title>
...
<center>
  ...
  <h2 style="color: white;" >PETICIONES DE ASESORIAS</h2>
                                ...
                                <div class="form-group mb-3">
                                    <div class="row">
                                        <div class="col-12 text-end">
                                            <button type="submit" class="btn btn-success btn-sm" style="width: 90px; ">Aceptar</button>
                                            <button type="submit" class="btn btn-danger btn-sm" style="width: 90px; ">Rechazar</button>
                                        </div>
                                    </div>
                                </div>
                          </td></tbody>
