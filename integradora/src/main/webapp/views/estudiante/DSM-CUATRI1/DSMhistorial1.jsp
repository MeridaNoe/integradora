...
<center>
    ...
    <h2 style="color: white;" >HISTORIAL DE ASESORIAS</h2>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <c:forEach>
                                    ...
                                    <td><c:out value="${usuario.getMatricula}"></c:out></td>
                                    <td><c:out value="${usuario.getCorreo}"></c:out></td>
                                    <td><c:out value="${usuario.getCarrera}"></c:out></td>
                                    <td><c:out value="${usuario.getCuatrimestre}"></c:out></td>
                                </c:forEach>
